...
const checkbox = document.querySelector('#show-checkbox');
...
checkbox.addEventListener('change', function(event){
    ...
    // console.log(books)
    Array.from(books).forEach(function (book) {
        // console.log("Book's classlist", book.classList);
        if (Array.from(book.classList).includes('hidden')){
            // console.log("Hidden was applied")
            book.classList.remove('hidden');
        } else {
            // console.log('Not applied Hidden class')
            book.classList.add('hidden')
        }
    });
});
...
//     console.log("Checkbox changed");
//     console.log(event)
//     const books = document.querySelectorAll('#book_list ul li');
