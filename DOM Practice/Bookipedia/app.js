...
//     li.innerHTML = `<span class="name">${new_book_name}</span>
...
// // const li = document.createElement('li');
// // li.innerHTML = `<span class="name">${df}</span>
// //     <span class="delete">delete</span>`;
...
<span class="delete">delete</span>`;
    ...
    let books_name = document.querySelector("#book-list li:last-child");
    let func = (books_name) => {
        books_name.innerHTML += " <strong>(Name Updated)</strong>";
    };
    func(books_name);
